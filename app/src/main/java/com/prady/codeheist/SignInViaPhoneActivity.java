...
public class SignInViaPhoneActivity extends AppCompatActivity implements EmailVerificationFragment.OnOtpVerifyClickedListener, SignupFragment.OnSignUpClickedListener {
    ...
    private void init()
    {
        mSendOtpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!isValid(phone))
                {
                    Toast.makeText(SignInViaPhoneActivity.this,"Please input correct phone number",Toast.LENGTH_SHORT).show();
                ...
                .verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                Toast.makeText(SignInViaPhoneActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            if(user.getDisplayName()==null) {
                                Toast.makeText(SignInViaPhoneActivity.this,"You are new, let's signup", Toast.LENGTH_SHORT).show();
                        ...
                        else
                        {
                            ...
                            if(task.getException()  instanceof FirebaseAuthInvalidCredentialsException)
                            {
                                ...
                                Toast.makeText(SignInViaPhoneActivity.this,"Invalid Otp Entered",Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                });
...
//                                super.onCodeSent(s, forceResendingToken);
    ...
    public void onSignUpButtonClicked(String email, String password, String uname) {
        ...
        ProgressBar progressBar = new ProgressBar(SignInViaPhoneActivity.this);
        ...
        user.updateEmail(email)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Toast.makeText(SignInViaPhoneActivity.this,task.getException().getMessage(),Toast.LENGTH_LONG).show();
                    }
                });
    }
